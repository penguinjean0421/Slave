...
class Settings(commands.Cog):
    ...
    def load_config(self):
        ...
        if os.path.exists(self.config_file):
            try:
                ...
                self.logger.error(f"설정 파일 로드 중 오류 발생: {e}", exc_info=True)
                self.server_configs = {}
        else:
            self.server_configs = {}
    ...
    def save_config(self):
        ...
        try:
            ...
            self.logger.error(f"설정 파일 저장 중 오류 발생: {e}", exc_info=True)
    ...
    def get_server_data(self, guild):
        ...
        try: 
            ...
            self.logger.error(f"서버 데이터 조회 중 오류 발생 (Guild: {guild.id}): {e}", exc_info=True)
            return {}
    ...
    async def delete_ticket_panel(self, guild):
        ...
        try:
            ...
            self.logger.error(f"패널 삭제 중 오류 발생 (Guild: {guild.id}): {e}", exc_info=True)
